...
<html lang="en">
	<head>
	    ...
	    <title>HOME | SRI VIMAL TEXTILES</title>
...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
	...
	<?php include('includes/side-menu.php');?>
			...
			<div class="col-xs-15 col-sm-12 col-md-9 homebanner-holder">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		...
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/f1.webp);">
			</div>
		</div>
		<div class="full-width-slider">
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">MENS</a></li>
					<li><a href="#furniture" data-toggle="tab">PRINTING</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Printing</h3>
